...
DEPENDENCIES=(
    ...
    "file" "getfattr" "git" "grep" "head" "java" "ln" "lz4"
    "make" "md5sum" "mkdir" "mount" "mv" "perl" "protoc"
    "python3" "rm" "sed" "sha1sum" "sort" "stat" "tail"
    "tar" "touch" "tr" "truncate" "umount" "unzip" "wc"
    "whoami" "xargs" "xxd" "zip" "zstd"
)
MISSING=()
